...
if ( ! function_exists( 'food_wp_comment' ) ) :
function food_wp_comment( $comment, $args, $depth ) {
...
?>
      ...
      <li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
            ...
            <div class="comment-body">
                  ...
                  <div style="display:block; color:red;"><?php esc_html_e('Your comment is awaiting moderation.', 'food-wp'); ?></div> 
                  <?php endif; ?>
            </div>
...
<li class="post pingback"> <p><?php esc_html_e('Pingback:', 'food-wp'); ?> <?php comment_author_link(); ?></p> </li>
