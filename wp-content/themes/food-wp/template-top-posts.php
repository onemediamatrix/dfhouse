<?php 
/* 
Template Name: Template - Popular Posts
*/ 
?>
...
<div class="wrap-fullwidth">
    ...
    <div class="wrap-content">
        <h3 class="title-module"><?php esc_html_e( 'Don\'t Miss!', 'food-wp' ); ?> <span><?php esc_html_e( 'popular posts by comments ..', 'food-wp' ); ?></span></h3>
        <ul id="infinite-articles" class="masonry_list js-masonry">

        <?php
            if ( get_query_var('paged') )  {  $paged = get_query_var('paged'); } elseif ( get_query_var('page') ) { $paged = get_query_var('page'); } else { $paged = 1;  }
            // The Query
            query_posts( array( 'post_type' => 'post', 'orderby' => 'comment_count', 'ignore_sticky_posts' => 1, 'paged' => $paged ) );
